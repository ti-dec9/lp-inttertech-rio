                ...
                <div class="row align-items-center justify-content-end">
                    ...
                    <div class="col-xxl-6 col-lg-6">
                        <div class="section-text">
                            ...
                            <!-- <p>O CONTROLADOR DE TEMPERATURA E PROCESSOS WEST 6100+ | P6100+ é o principal controlador de
                                processos/temperatura da WEST. Faz parte da série Plus e eleva a flexibilidade e
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol>
                            <li>Controle de temperatura em processos industriais: O Controlador West 6100+ | P6100+ pode
                                ...
                                preciso da temperatura, garantindo a qualidade e eficiência do processo.</li>
                            <li>Aplicações em laboratórios: Em laboratórios de pesquisa e desenvolvimento, o controlador
                                pode ser usado para controlar a temperatura em estufas, incubadoras, banhos
                                termostáticos e outras aplicações que requerem precisão no controle térmico.</li>
                            <li>Controle de temperatura em equipamentos de teste: O Controlador West 6100+ | P6100+
                                também pode ser empregado em equipamentos de teste que exigem controle preciso da
                                temperatura, como testes de resistência de materiais, testes de desempenho de
                                componentes eletrônicos, entre outros.</li>
                            <li>Sistemas de climatização e refrigeração: O controlador pode ser utilizado para controlar
                                a temperatura em sistemas de climatização e refrigeração, como sistemas de ar
                                condicionado, câmaras frigoríficas, geladeiras industriais, garantindo um ambiente
                                adequado para armazenamento de produtos perecíveis.</li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-5">
                        <div class="top-wrapper">
                            <p>A IntertechRio é uma empresa brasileira especializada no fornecimento de soluções em
                                instrumentação e controle de processos (pressão, temperatura, vazão, análise de gases,
                                umidade, nível), HVAC, e sistemas de segurança específica contra descargas elétricas
                                atmosféricas. Todas essas soluções só são possíveis através da representação de
                                fabricantes globais como GE SENSING, LEC GLOBAL, HAMILTON, SPTECH, dentre outras que são
                                líderes em seus respectivos segmentos de mercado.</p>
                            <p>Desde o ano de 2001, a IntertechRio atende organizações de diversos segmentos de mercado,
                                aliando confiabilidade, versatilidade e credibilidade, além do aprimoramento de
                                procedimentos em todas as etapas de negociação, desde a implementação do projeto até a
